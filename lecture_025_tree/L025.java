...
public class L025 {
    ...
    public static void levelOrder01(TreeNode root) {
       ...
       while(!q.isEmpty()){
           ...
           if(rvtx.left!=null) q.addLast(rvtx.left);
           if(rvtx.right!=null) q.addLast(rvtx.right);
       }
        return;
    }
    ...
    public static void levelOrder02(TreeNode root) {
        ...
        while(!q1.isEmpty()){
            ...
            System.out.print(rvtx.val + " , ");
            if(rvtx.left!=null) q2.addLast(rvtx.left);
            if(rvtx.right!=null) q2.addLast(rvtx.right);
    ...
    public static void verticalOrder(TreeNode root) {
        ...
        while(!q.isEmpty()){
            ...
            if(rvtx.t.left!=null) q.addLast(new VOpair(rvtx.t.left,rvtx.i-1));
            if(rvtx.t.right!=null) q.addLast(new VOpair(rvtx.t.right,rvtx.i+1));
        }
    ...
    public static void leftview(TreeNode root) {
        ...
        while(q.size()!=0) {
            ...
            System.out.println(q.getFirst().val); 
